...
<div class="container breadcrumbs row mt-3 offset-1 ">
  ...
  <strong  style="font-weight: 500;word-spacing: normal;">Đồng hồ nữ / Trang 1</strong>
</div>
</div>
<!--  -->
<!--single banner-->
<div class="container">
 ...
 <h2
  ...
  >
  Đồng hồ nữ quý phái, chính hãng 100%
 </h2>
 <p class="col-sm-12 col-lg-12 col-md-12">
  <img decoding="async" 
       class="banner-top" 
       style="object-fit: fill"
       src="./image_manh/dong-ho-nu-1.webp" 
  ...
  <p class="caption-top" >
    Casio là thương hiệu đồng hồ lâu đời trong ngành công nghiệp đồng hồ tại Nhật Bản.
    Những mẫu đồng hồ Casio nam nữ được yêu thích bởi thiết kế đơn giản,<br> dễ dàng để xem giờ,
     được trang bị đầy đủ các công nghệ mới nhất và có giá bán cực kỳ rẻ. 
    Ngoài ra, đồng hồ Casio chính hãng còn nổi bật với chức năng<br> đa dạng giúp ích cho người dùng vào những hoạt động đời sống thường ngày…</p>
  </div>
  <div
class="container"
  ...
  <form class="filter">
      <div class="item">
          ...
          <select name="category">
              <option value="">---</option>
              <option value="BABY-G">CASIO BABY-G</option>
              <option value="SHEEN">CASIO SHEEN</option>
              <option value="LTP">CASIO LTP</option>
          </select>
      </div>
      <div class="item">
          ...
          <select name="size">
              ...
              <option value="30.2">30.2mm</option>
              <option value="32">32mm</option>
              <option value="32.1">32.1mm</option>
              <option value="37.9">37.9mm</option>
...
<!--      -->
 ...
 <nav aria-label="Page navigation example">
  <ul class="pagination justify-content-center">
    <li class="page-item ">
      <a class="page-link" href="dongHoNu.php" tabindex="-1" aria-disabled="true">Trang đầu</a>
    </li>
    <li class="page-item"><a class="page-link" href="dongHoNu.php">1</a></li>
    <li class="page-item"><a class="page-link">2</a></li>
    <li class="page-item"><a class="page-link">3</a></li>
    <li class="page-item">
      <a class="page-link" href="dongHoNu.php">Trang cuối</a>
    </li>
  </ul>
</nav>
<!--  -->
...
<script src="./js/filterwomen.js"></script>
